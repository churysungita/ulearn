...
class CourseController extends Controller
{
    ...
    public function courseView(Request $request, $course_slug = '')
    {
    ...
    public function courseLearn(Request $request, $course_slug = '')
    {   
        $course_breadcrumb = Session::get('course_breadcrumb');
        $course = Course::where('course_slug', $course_slug)->first();
    ...
    public function courseEnrollAPI(Request $request, $course_slug = '', $lecture_slug = '', $is_sidebar = 'true')
    {
        $course = Course::where('course_slug', $course_slug)->first();
    ...
    public function courseList(Request $request, $course_slug = '')
    {
        $paginate_count = 9;
    ...
    public function checkout(Request $request, $course_slug = '')
    {
        $course_breadcrumb = Session::get('course_breadcrumb');
        $course = Course::where('course_slug', $course_slug)->first();
    ...
    public function instructorCourseImage(Request $request, $course_id = '')
    {   
        $course = Course::find($course_id);
    ...
    public function instructorCourseCurriculum(Request $request, $course_id = '')
    {   
        $course = Course::find($course_id);
 ...
 // Use a raw SQL query to count existing slugs
...
if (strtoupper(substr(PHP_OS, 0, 3)) === 'WIN') {               $ffmpeg_path = base_path().'\resources\assets\ffmpeg\ffmpeg_win\ffmpeg';            } else {                $ffmpeg_path = base_path().'/resources/assets/ffmpeg/ffmpeg_lin/ffmpeg.exe';            }
    ...
    public function postLectureAudioSave(Request $request, $lid)
    {
        $course_id = $request->input('course_id');
        ...
        $file_title = Str::slug($file_title, "-");
        $file_name = Str::slug($file_name, "-");
