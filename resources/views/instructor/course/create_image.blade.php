...
<script type="text/javascript">
    ...
    { 
        //image crop start
// Image crop start
$(".gambar").attr("src", @if(optional($course->course_image)->isNotEmpty() && Storage::exists($course->course_image))"{{ Storage::url($course->course_image) }}" @else "{{ asset('backend/assets/images/course_detail.jpg') }}" @endif);
