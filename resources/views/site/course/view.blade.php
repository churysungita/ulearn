    ...
    <div class="container">
        <div class="row mt-4">
            ...
            <div class="col-xl-9 col-lg-9 col-md-8">
                  ...
                  <img src="@if(optional($course->course_image)->isNotEmpty() && Storage::exists($course->course_image)){{ Storage::url($course->course_image) }}@else{{ asset('backend/assets/images/course_detail.jpg') }}@endif">
