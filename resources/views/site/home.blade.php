                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        ...
                        <div class="course-block mx-auto">
                            <a href="{{ route('course.view', $course->course_slug) }}">
                                <main>
<img src="@if(optional($course->thumb_image)->isNotEmpty() && Storage::exists($course->thumb_image)){{ Storage::url($course->thumb_image) }}@else{{ asset('backend/assets/images/course_detail_thumb.jpg') }}@endif">
